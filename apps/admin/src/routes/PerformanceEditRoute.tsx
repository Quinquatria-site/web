...
export function PerformanceEditRoute() {
  ...
  const editing = params.id && params.id !== 'new' ? performanceById(Number(params.id)) : undefined
    ...
    <div className={styles.screen}>
      <div className={styles.section}>
        ...
        <div className={styles.field}>
          <span className={styles.label}>일차</span>
          <SegmentedControl
            aria-label="축제 일차"
            value={date}
      ...
      <div className={styles.section}>
        ...
        {missing.length > 0 && (
          <p className={`${styles.hint} ${styles.langMissing}`}>
            {missing.join('·')} 이 비어 있습니다 — 그 언어 사용자에게는 이 공연이 보이지 않습니다.
          </p>
        )}
