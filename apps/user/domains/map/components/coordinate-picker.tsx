...
export function CoordinatePicker() {
  ...
  return (
    <div className="pointer-events-none absolute top-4 left-4 z-[1000] rounded-full border liquid-glass liquid-glass--control px-3 py-1.5 font-mono text-xs text-ink">
      x: {point.x}, y: {point.y}
    </div>
  )
}
