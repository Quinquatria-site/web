...
export default async function Page({ params }: PageProps<'/[lang]/admin'>) {
  ...
  return (
    ...
    >
      ...
      <div className="relative mt-6 size-40 overflow-hidden rounded-full border border-line bg-surface-muted">
        <Image
          src="/me.png"
          alt={admin.portrait}
          fill
      ...
      <Link
        href={langHref(lang)}
        className="mt-8 flex h-12 items-center gap-2 rounded-full bg-accent px-6 text-[15px] font-semibold text-accent-ink"
      >
